![Icon](https://raw.githubusercontent.com/manix84/discord_gmod_bot/master/images/icon/icon_64x.png)
# Discord GMod Bot 
...
- You must have a [Nodejs](https://nodejs.org) server (I used [Heroku.com](https://heroku.com))

### Installation
1. Clone this repository (to e.g. your home folder) and install the requirements
     ```bash
     cd ~
     git clone https://github.com/manix84/ttt_discord_bot.git
     cd ttt_discord_bot
...
- Connect your Steam Account with the bot by typing `!discord YourDiscordTag` in the ingame chat. E.g `!discord Manix84`. If you're lazy and there is nobody else with your discord discriminator (`#4402`) in the ttt channel, it's enough if you use this. E.g. `!discord 4402`
...
- Marcel Transier - The original creator of [ttt_discord_bot](https://github.com/marceltransier/ttt_discord_bot.git)
